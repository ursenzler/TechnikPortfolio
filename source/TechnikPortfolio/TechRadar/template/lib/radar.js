...
//     .left(function(d) { var x = polar_to_raster(d.pc.radius, d.pc.t)[0];
//                         //console.log("name:" + d.name + ", x:" + x); 
//                         return x;})
//     .bottom(function(d) { var y = polar_to_raster(d.pc.radius, d.pc.t)[1];                                 
...
function makeEmptyIfUndefined(list) {
    if (list) {
        return list;
    } else {
        return [];
...
for (var i = 0; i < radar_data.length; i++) {
    ...
    radar.add(pv.Label)             
        ...
        .add( pv.Dot )            
            ...
            .data(makeEmptyIfUndefined(itemsByStage[stageIdx]))
