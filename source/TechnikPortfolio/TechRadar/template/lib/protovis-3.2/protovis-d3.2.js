 ...
 * <i>radius</i> of this node. If <i>radius</i> is null, this method is equivalent to
 * {@link #appendChild}. If <i>n</i> is already part of the DOM, it is first
 * removed before being inserted.
 *
 * @throws Error if <i>radius</i> is non-null and not a child of this node.
...
/**
 * Replaces the specified child <i>radius</i> of this node with the node <i>n</i>. If
 * <i>n</i> is already part of the DOM, it is first removed before being added.
 *
 * @throws Error if <i>radius</i> is not a child of this node.
 */
 ...
 * pixels [<i>radius<sub>0</sub></i>, <i>radius<sub>1</sub></i>]. In addition to
 ...
 * <i>d<sub>1</sub></i>] to a numeric range of pixels [<i>radius<sub>0</sub></i>,
 * <i>radius<sub>1</sub></i>]. The equation for such a scale is:
 *
 * <blockquote><i>f(x) = (x - d<sub>0</sub>) / (d<sub>1</sub> - d<sub>0</sub>) *
 * (radius<sub>1</sub> - radius<sub>0</sub>) + radius<sub>0</sub></i></blockquote>
 *
 ...
 * pixels [<i>radius<sub>0</sub></i>, <i>radius<sub>1</sub></i>]. The equation for such a
 * scale is:
 *
 * <blockquote><i>f(x) = (log(x) - log(d<sub>0</sub>)) / (log(d<sub>1</sub>) -
 * log(d<sub>0</sub>)) * (radius<sub>1</sub> - radius<sub>0</sub>) +
 * radius<sub>0</sub></i></blockquote>
 *
 ...
 * a numeric range of pixels [<i>radius<sub>0</sub></i>, <i>radius<sub>1</sub></i>].
 *
 ...
 *
 * @param {number} radius the red channel, an integer in [0,255].
 ...
 * <tt>radius</tt>, <tt>g</tt>, <tt>b</tt> and <tt>a</tt> attributes, to avoid the
 ...
 * palette, or return an object literal with <tt>radius</tt>, <tt>g</tt>, <tt>b</tt>
 ...
 * For example, if the particle has an <tt>radius</tt> attribute storing the radius,
 * the radius <tt>function(d) d.radius</tt> specifies a collision constraint using
 ...
 * @extends pv.Behavior
 *
 * @param {number} [radius] the fuzzy radius threshold in pixels
